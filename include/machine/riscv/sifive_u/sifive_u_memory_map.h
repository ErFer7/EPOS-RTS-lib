...
public:
    enum : unsigned long {
        ...
        BOOT_STACK      = (Traits<Machine>::supervisor ? FLAT_MEM_MAP : LAST_PAGE) - Traits<Machine>::STACK_SIZE * Traits<Build>::CPUS, // will be used as the stack's base, not the stack pointer
        FREE_BASE       = RAM_BASE,
